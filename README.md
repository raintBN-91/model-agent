...
Skill 注册采用三级 Tier 体系（`skills/tiers.json`）：Tier1 核心智能体（27）、Tier2 扩展技能（121）、Tier3 长尾技能（148），共计 296 个注册 Skill。实际 `skills/` 目录包含 301 个主 SKILL.md 文件（含子目录引用共 376 个），覆盖 11 个分类：
