...
|---------|-------------|---------------|
| Elementwise (ReLU, GELU, Add...) | [`references/templates/elementwise_op_host.cpp`](references/templates/elementwise_op_host.cpp) | [`references/templates/elementwise_op_kernel.cpp`](references/templates/elementwise_op_kernel.cpp) |
| 行处理 (LayerNorm, Softmax...) | [`references/templates/row_op_host.cpp`](references/templates/row_op_host.cpp) | [`references/templates/row_op_kernel.cpp`](references/templates/row_op_kernel.cpp) |
