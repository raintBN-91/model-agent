# Issue #4148: [Bug]: 310p运行qwen3报错

## 基本信息

- **编号**: #4148
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/4148
- **创建时间**: 2025-11-12T07:35:30Z
- **关闭时间**: 2025-12-23T11:24:22Z
- **更新时间**: 2026-01-24T17:40:03Z
- **提交者**: @ReolC
- **评论数**: 14
...
```text
root@dcdcce86dca8:/workspace# python collect_env.py
...
+===============================+=================+======================================================+
| 64      310P3                 | OK              | NA           32                0     / 0             |
| 0       0                     | 0000:03:00.0    | 0            1526 / 44280                            |
+-------------------------------+-----------------+------------------------------------------------------+
| 64      310P3                 | OK              | NA           32                0     / 0             |
| 1       1                     | 0000:03:00.0    | 0            1429 / 43693                            |
+===============================+=================+======================================================+
| 32832   310P3                 | OK              | NA           31                0     / 0             |
| 0       2                     | 0000:83:00.0    | 0            1623 / 44280                            |
+-------------------------------+-----------------+------------------------------------------------------+
| 32832   310P3                 | OK              | NA           31                0     / 0             |
| 1       3                     | 0000:83:00.0    | 0            1308 / 43693                            |
+===============================+=================+======================================================+
+-------------------------------+-----------------+------------------------------------------------------+
| NPU     Chip                  | Process id      | Process name             | Process memory(MB)        |
+===============================+=================+======================================================+
| No running processes found in NPU 64                                                                   |
+===============================+=================+======================================================+
...
-p 8000:8000 \
-it quay.io/ascend/vllm-ascend:v0.11.0rc1 bash
```

详细日志在附件

[error.log](https://github.com/user-attachments/files/23494079/error.log)
