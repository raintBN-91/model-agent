# Issue #482: [Usage]:910B2 部署qwen2.5-vl-72B，效果比GPU部署效果差很多

## 基本信息

- **编号**: #482
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/482
- **创建时间**: 2025-04-08T07:52:03Z
- **关闭时间**: 2025-05-14T03:38:54Z
- **更新时间**: 2025-05-15T04:11:05Z
- **提交者**: @15626471095
- **评论数**: 4
...
910B2 部署qwen2.5-vl-72B，效果比GPU部署效果差很多
```shell
vllm serve Qwen2.5-VL-72B-Instruct --served-model-name Qwen2.5-VL-72B-Instruct --trust-remote-code \
--enable-auto-tool-choice --tool-call-parser hermes  --limit_mm_per_prompt 'image=10' \
--max-model-len 65536 -tp 8 -pp 1 \
--host 0.0.0.0 --port 8080 --gpu-memory-utilization 0.95 --max_num_seqs 1024
```
