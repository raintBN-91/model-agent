...
│ 阶段 3：生成 DESIGN.md                                            │
├───────────────────────────────────────────────────────────────────┤
│  基于模板 references/templates/design-template.md 生成完整 DESIGN.md 草稿    │
│  包含全部 9 个章节                                                │
│  成功标准：                                                       │
...
DESIGN.md 包含 9 个章节，模板文件位于: [templates/design-template.md](references/templates/design-template.md)
