# Issue #1458: [Bug]: NotImplementedError: ACL Graph does not support deepseek. Please try torchair graph mode to serve deepseek models on vllm-ascend. Or set `enforce_eager=True` to use eager mode

## 基本信息

- **编号**: #1458
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/1458
- **创建时间**: 2025-06-26T09:27:20Z
- **关闭时间**: 2025-06-26T09:59:30Z
- **更新时间**: 2025-06-26T09:59:30Z
- **提交者**: @boomfh
- **评论数**: 0
