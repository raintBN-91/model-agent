# Issue #2702: [Bug]: Failure in NPU Operator Compilation/Execution with Expert Parallelism in Graph Mode (MoE/RoPE)

## 基本信息

- **编号**: #2702
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/2702
- **创建时间**: 2025-09-02T09:08:33Z
- **关闭时间**: 2025-09-08T06:52:34Z
- **更新时间**: 2025-09-08T06:52:34Z
- **提交者**: @yuweivvv
- **评论数**: 0
...
vLLM Version: 0.10.1rc2.dev334+g3462c1c52.d20250902 (git sha: 3462c1c52, date: 20250902)
vLLM Ascend Version: 0.10.0rc2.dev100+gcf96366.d20250902 (git sha: cf96366, date: 20250902)
...
ASCEND_VISIBLE_DEVICES=0,8,6,14,4,12,7,15,3,11,1,9,2,10,5,13
...
+===========================+===============+====================================================+
| 0     910B2C              | OK            | 94.6        44                0    / 0             |
| 0                         | 0000:5A:00.0  | 0           0    / 0          3421 / 65536         |
+===========================+===============+====================================================+
| 1     910B2C              | OK            | 99.5        45                0    / 0             |
| 0                         | 0000:19:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 2     910B2C              | OK            | 89.7        43                0    / 0             |
| 0                         | 0000:49:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 3     910B2C              | OK            | 90.8        43                0    / 0             |
| 0                         | 0000:39:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 4     910B2C              | OK            | 90.4        44                0    / 0             |
| 0                         | 0000:DA:00.0  | 0           0    / 0          3405 / 65536         |
+===========================+===============+====================================================+
| 5     910B2C              | OK            | 92.6        46                0    / 0             |
| 0                         | 0000:99:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 6     910B2C              | OK            | 92.9        43                0    / 0             |
| 0                         | 0000:B8:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 7     910B2C              | OK            | 91.3        44                0    / 0             |
| 0                         | 0000:C8:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 8     910B2C              | OK            | 92.4        43                0    / 0             |
| 0                         | 0000:59:00.0  | 0           0    / 0          3417 / 65536         |
+===========================+===============+====================================================+
| 9     910B2C              | OK            | 96.3        44                0    / 0             |
| 0                         | 0000:18:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 10    910B2C              | OK            | 90.3        43                0    / 0             |
| 0                         | 0000:48:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 11    910B2C              | OK            | 92.7        45                0    / 0             |
| 0                         | 0000:38:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 12    910B2C              | OK            | 94.7        44                0    / 0             |
| 0                         | 0000:D9:00.0  | 0           0    / 0          3405 / 65536         |
+===========================+===============+====================================================+
| 13    910B2C              | OK            | 92.3        45                0    / 0             |
| 0                         | 0000:98:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 14    910B2C              | OK            | 90.7        44                0    / 0             |
| 0                         | 0000:B9:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
| 15    910B2C              | OK            | 92.3        45                0    / 0             |
| 0                         | 0000:C9:00.0  | 0           0    / 0          3404 / 65536         |
+===========================+===============+====================================================+
+---------------------------+---------------+----------------------------------------------------+
...
WORK_DIR=/tmp/theta_workdir

mkdir -p "$WORK_DIR"
mkdir -p "$MC_LOG_DIR"

vllm serve /mnt/deepseek/DeepSeek-R1-W8A8-VLLM \
    --port 8200 \
    ...
    --quantization ascend \
    --additional-config '{ "torchair_graph_config":{ "enabled":true, "graph_batch_sizes": [24]}}'
```
The error details are as follows:
```text
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712]         cos or sin batchSize must same as x batchSize.[FUNC:GetShapeAttrsInfo][FILE:interleave_rope_tiling.cpp][LINE:124]
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712]         Op InterleaveRope tiling failed[FUNC:TbeOptilingPyInterfaceNew][FILE:op_tiling_py.cc][LINE:1746]
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712]         Compile operator failed, cause: Template constraint, detailed information: Tiling func of op_type InterleaveRope failed, failure details:
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712] Compile_info: {'device_id': '0', '_cube_vector_core_type': 'VectorCore'}
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712] Inputs: {'shape': (32, 8, 1, 64), 'ori_shape': (32, 8, 1, 64), 'format': 'NCHW', 'sub_format': 0, 'ori_format': 'NCHW', 'dtype': 'bfloat16', 'addr_type': 0, 'total_shape': [32, 8, 1, 64], 'slice_offset': (), 'L1_addr_offset': 0, 'L1_fusion_type': -1, 'L1_workspace_size': -1, 'valid_shape': (), 'split_index': 0, 'atomic_type': '', 'input_c_values': 8, 'range': [[32, 32], [8, 8], [1, 1], [64, 64]], 'param_name': 'x_in__'}
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712] {'shape': (24, 1, 1, 64), 'ori_shape': (24, 1, 1, 64), 'format': 'NCHW', 'sub_format': 0, 'ori_format': 'NCHW', 'dtype': 'bfloat16', 'addr_type': 0, 'total_shape': [24, 1, 1, 64], 'slice_offset': (), 'L1_addr_offset': 0, 'L1_fusion_type': -1, 'L1_workspace_size': -1, 'valid_shape': (), 'split_index': 0, 'atomic_type': '', 'input_c_values': 1, 'range': [[24, 24], [1, 1], [1, 1], [64, 64]], 'param_name': 'cos_in__'}
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712] {'shape': (24, 1, 1, 64), 'ori_shape': (24, 1, 1, 64), 'format': 'NCHW', 'sub_format': 0, 'ori_format': 'NCHW', 'dtype': 'bfloat16', 'addr_type': 0, 'total_shape': [24, 1, 1, 64], 'slice_offset': (), 'L1_addr_offset': 0, 'L1_fusion_type': -1, 'L1_workspace_size': -1, 'valid_shape': (), 'split_index': 0, 'atomic_type': '', 'input_c_values': 1, 'range': [[24, 24], [1, 1], [1, 1], [64, 64]], 'param_name': 'sin_in__'}
(EngineCore_0 pid=21001) ERROR 09-01 20:08:46 [core.py:712] Outputs: {'shape': (32, 8, 1, 64), 'ori_shape': (32, 8, 1, 64), 'format': 'NCHW', 'sub_format': 0, 'ori_format': 'NCHW', 'dtype': 'bfloat16', 'addr_type': 0, 'total_shape': [32, 8, 1, 64], 'slice_offset': (), 'L1_addr_offset': 0, 'L1_fusion_type': -1, 'L1_workspace_size': -1, 'valid_shape': (), 'split_index': 0, 'atomic_type': '', 'input_c_values': 8, 'range': [[32, 32], [8, 8], [1, 1], [64, 64]], 'param_name': 'y_out_'}
```
