# Issue #4994: [Usage]: Run multi-models

## 基本信息

- **编号**: #4994
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/4994
- **创建时间**: 2025-12-13T12:42:43Z
- **关闭时间**: 2025-12-30T06:57:02Z
- **更新时间**: 2025-12-30T06:57:02Z
- **提交者**: @Potabk
- **评论数**: 1
...
This script runs deepseek-ocr and paddle-ocr-vl and hunyuan-ocr
```python
...
def run_hunyuan_vl(questions: list[str], modality: str) -> ModelRequestData:
    ...
    model_name = "Tencent-Hunyuan/HunyuanOCR"
...
python run_vision_language.py --model-type paddleocr_vl
```
