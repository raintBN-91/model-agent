# Issue #3165: [Feature]: Contribute Omni-Infer feature to vLLM Ascend upstream

## 基本信息

- **编号**: #3165
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/3165
- **创建时间**: 2025-09-24T22:53:55Z
- **关闭时间**: 2025-12-23T12:53:49Z
- **更新时间**: 2025-12-23T12:53:49Z
- **提交者**: @Yikun
- **评论数**: 2
...
Below are initial docs for `examples/omniinfer`
...
### cc list
@jianzs @ApsarasX @wangxiyuan @MengqingCao @ganyi1996ppo
