...
### 7. 使用说明
将[链接](https://gitcode.com/MoFixGo/deploy-agent/tree/main/ascend-history-to-skill)中的skills，具体内容如上，加载到code agent工具对应目录下，并输入提示词：把过去做过的xxx模型的昇腾迁移优化整理成skills，大模型会自动收集已经适配的经验，并沉淀出模型skills
