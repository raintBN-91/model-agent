# Issue #2460: [Bug]: Qwen3-30B-A3B DP+EP offline inference timeout

## 基本信息

- **编号**: #2460
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/2460
- **创建时间**: 2025-08-20T09:22:13Z
- **关闭时间**: 2025-12-29T13:03:36Z
- **更新时间**: 2025-12-29T13:03:36Z
- **提交者**: @wxsIcey
- **评论数**: 2
...
vLLM Version: 0.10.1rc2.dev59+g0167efe20 (git sha: 0167efe20)
vLLM Ascend Version: 0.9.2rc2.dev200+g1327f9be1 (git sha: 1327f9be1)
...
+===========================+===============+====================================================+
| 0     Ascend910           | OK            | 178.3       36                0    / 0             |
| 0     0                   | 0000:9D:00.0  | 0           0    / 0          3416 / 65536         |
+------------------------------------------------------------------------------------------------+
| 0     Ascend910           | OK            | -           36                0    / 0             |
| 1     1                   | 0000:9F:00.0  | 0           0    / 0          3191 / 65536         |
+===========================+===============+====================================================+
| 1     Ascend910           | OK            | 186.8       36                0    / 0             |
| 0     2                   | 0000:99:00.0  | 0           0    / 0          3414 / 65536         |
+------------------------------------------------------------------------------------------------+
| 1     Ascend910           | OK            | -           35                0    / 0             |
| 1     3                   | 0000:9B:00.0  | 0           0    / 0          3189 / 65536         |
+===========================+===============+====================================================+
| 2     Ascend910           | OK            | 177.0       36                0    / 0             |
| 0     4                   | 0000:95:00.0  | 0           0    / 0          3415 / 65536         |
+------------------------------------------------------------------------------------------------+
| 2     Ascend910           | OK            | -           36                0    / 0             |
| 1     5                   | 0000:97:00.0  | 0           0    / 0          3187 / 65536         |
+===========================+===============+====================================================+
| 3     Ascend910           | OK            | 178.3       36                0    / 0             |
| 0     6                   | 0000:91:00.0  | 0           0    / 0          3414 / 65536         |
+------------------------------------------------------------------------------------------------+
| 3     Ascend910           | OK            | -           36                0    / 0             |
| 1     7                   | 0000:93:00.0  | 0           0    / 0          3188 / 65536         |
+===========================+===============+====================================================+
...
+===========================+===============+====================================================+
| 5     Ascend910           | OK            | 189.8       36                0    / 0             |
| 0     10                  | 0000:89:00.0  | 0           0    / 0          3403 / 65536         |
+------------------------------------------------------------------------------------------------+
| 5     Ascend910           | OK            | -           36                0    / 0             |
| 1     11                  | 0000:8B:00.0  | 0           0    / 0          3205 / 65536         |
+===========================+===============+====================================================+
| 6     Ascend910           | OK            | 182.9       39                0    / 0             |
| 0     12                  | 0000:85:00.0  | 0           0    / 0          3403 / 65536         |
+------------------------------------------------------------------------------------------------+
| 6     Ascend910           | OK            | -           36                0    / 0             |
| 1     13                  | 0000:87:00.0  | 0           0    / 0          3207 / 65536         |
+===========================+===============+====================================================+
| 7     Ascend910           | OK            | 186.9       36                0    / 0             |
| 0     14                  | 0000:81:00.0  | 0           0    / 0          3417 / 65536         |
+------------------------------------------------------------------------------------------------+
...
if __name__ == "__main__":
    main()
```
The parameters are set as above. When I perform inference, it gets stuck at the processed prompts stage.

<img width="1356" height="741" alt="Image" src="https://github.com/user-attachments/assets/062d3ab8-dc2e-4498-bcda-51b22edcf205" />
