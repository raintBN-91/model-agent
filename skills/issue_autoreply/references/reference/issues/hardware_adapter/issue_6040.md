# Issue #6040: [Main2Main] Upgrade vllm commit to 0120 
...
3.  ✅Upgrade vllm commit to: 0120(148117ea2e689cd43df4be6892671a17cdae5833)
     ...
     2. Modify  `tests/ut/spec_decode/test_eagle_proposer.py` due to https://github.com/vllm-project/vllm/pull/24322
change `se

## 基本信息
- **编号**: #6040
- **作者**: Meihan-chen
- **创建时间**: 2026-01-20T07:16:53Z
- **关闭时间**: 2026-01-27T00:45:05Z
...
## 链接
- [查看原Issue](https://github.com/vllm-project/vllm-ascend/pull/6040)
