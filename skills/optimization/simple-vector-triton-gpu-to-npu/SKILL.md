...
```python
# 1. 分析源代码
# 使用 references/templates/analysis_template.md 生成语义分析报告
...
使用 [templates/analysis_template.md](references/templates/analysis_template.md) 生成分析报告。
...
- 分析模板：[templates/analysis_template.md](references/templates/analysis_template.md)
