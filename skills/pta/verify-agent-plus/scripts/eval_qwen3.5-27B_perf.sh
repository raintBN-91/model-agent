...
RESULT_DIR="${RESULT_DIR:-./qwen35_perf_results}"

export VLLM_USE_MODELSCOPE=true

echo "=========================================="
echo "  Qwen3.5-27B 性能评估"
echo "=========================================="
echo "模型:       ${MODEL_PATH}"
echo "模式:       ${BENCH_MODE}"
echo ""
...
case "${BENCH_MODE}" in
    ...
    throughput)
        ...
        echo "离线吞吐测试 (tokens/sec)"
        ;;
    *)
        echo "❌ 不支持的模式: ${BENCH_MODE}"
        echo "支持: serve, latency, throughput"
        exit 1
        ;;
esac
