# Issue #617: [Bug]: DP Attention in V1 error: cannot set moe all to all group due to repeated initializations

## 基本信息

- **编号**: #617
- **状态**: closed
- **链接**: https://github.com/vllm-project/vllm-ascend/issues/617
- **创建时间**: 2025-04-22T09:30:16Z
- **关闭时间**: 2025-04-22T09:41:35Z
- **更新时间**: 2025-04-22T09:41:35Z
- **提交者**: @HanlinDu
- **评论数**: 0
